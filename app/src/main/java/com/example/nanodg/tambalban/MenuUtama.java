...
public class MenuUtama extends AppCompatActivity {
    ...
    CardView btnbengkel, btnaksesoris,btntambal,btnAkun;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAkun = (CardView) findViewById(R.id.btnAkun);
        ...
        btnAkun.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(LoginActivity.getActIntent(MenuUtama.this));
            }
        });
    }
    public void initToolbar(){
        ...
        actionBar.setTitle("Halaman Menu Utama");
    }
    @Override
