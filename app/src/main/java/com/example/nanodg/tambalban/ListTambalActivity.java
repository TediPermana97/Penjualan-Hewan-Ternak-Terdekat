...
public class ListTambalActivity extends AppCompatActivity implements AdapterTambalRecyclerView.FirebaseDataListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        actionBar.setTitle("List Ayam Dan Itik");
    ...
    public void cari(){
        ...
        database.child("tambah").orderByChild("nama").startAt(hasil).endAt(hasil + "\uf8ff").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new AdapterTambalRecyclerView(daftarTambah, ListTambalActivity.this);
        ...
        if(database!=null){
            database.child("tambah").child(tambah.getKey()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    Toast.makeText(ListTambalActivity.this,"success delete", Toast.LENGTH_LONG).show();
                }
            });
